...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"contact.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"validateForm.js":[function(require,module,exports) {
"use strict";
...
var validateForm = function validateForm(data, letters, idName, attr) {
  ...
  if (data) {
    ...
    if (!data.match(letters)) {
      var _text = idName === 'email' ? 'Please enter a valid email address' : 'Please enter a correct input';
...
var loginForm = document.querySelector('.form-data');
var logoutBtn = document.querySelector('.nav-logout');
var contactForm = document.querySelector('.sendMessage');
console.log('HEllo1');
...
if (contactForm) {
  contactForm.addEventListener('click', function (e) {
    ...
    var message = document.getElementById('message').value; // if(bool == false) {
