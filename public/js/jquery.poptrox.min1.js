/* jquery.poptrox1.js v2.5.2-dev | (c) n33 | n33.co | MIT licensed */ ! function (e) {
    e.fn.poptrox1_disableSelection = function () {
        ...
        if (this.length > 1) {
            for (var p = 0; p < this.length; p++) e(this[p]).poptrox1(o);
            return e(this)
        }
        var i, s, r = e.extend({
                preload: !1,
        ...
        if (r.usePopupDefaultStyling && (x.css("background", r.popupBackgroundColor).css("color", r.popupTextColor).css("padding", r.popupPadding + "px"), m.length > 0 && (x.css("padding-bottom", r.popupCaptionHeight + "px"), m.css("position", "absolute").css("left", "0").css("bottom", "0").css("width", "100%").css("text-align", "center").css("height", r.popupCaptionHeight + "px").css("line-height", r.popupCaptionHeight + "px"), r.popupCaptionTextSize && m.css("font-size", popupCaptionTextSize)), C.length > 0 && C.html(r.popupCloserText).css("font-size", r.popupCloserTextSize).css("background", r.popupCloserBackgroundColor).css("color", r.popupCloserTextColor).css("display", "block").css("width", "40px").css("height", "40px").css("line-height", "40px").css("text-align", "center").css("position", "absolute").css("text-decoration", "none").css("outline", "0").css("top", "0").css("right", "-40px"), b.length > 0 && b.html("").css("position", "relative").css("font-size", r.popupLoaderTextSize).on("startSpinning", function (o) {
            ...
            P.css("font-size", "75px").css("text-align", "center").css("color", "#fff").css("text-shadow", "none").css("height", "100%").css("position", "absolute").css("top", "0").css("opacity", "0.35").css("cursor", "pointer").css("box-shadow", "inset 0px 0px 10px 0px rgba(0,0,0,0)").poptrox1_disableSelection();
            var k, T;
        ...
        return u.on("resize orientationchange", function () {
            ...
            return e.preventDefault(), e.stopPropagation(), x.trigger("poptrox1_close"), !0
        }), y.on("click", function (e) {
            e.stopPropagation(), e.preventDefault(), x.trigger("poptrox1_next")
        }), S.on("click", function (e) {
            e.stopPropagation(), e.preventDefault(), x.trigger("poptrox1_previous")
            ...
            e.preventDefault(), e.stopPropagation(), x.trigger("poptrox1_close")
        }), x.css("display", "inline-block").css("vertical-align", "middle").css("position", "relative").css("z-index", 1).css("cursor", "auto").appendTo(l).hide().on("poptrox1_next", function () {
            var e = h + 1;
            e >= d.length && (e = 0), x.trigger("poptrox1_switch", [e])
        }).on("poptrox1_previous", function () {
            var e = h - 1;
            0 > e && (e = d.length - 1), x.trigger("poptrox1_switch", [e])
        }).on("poptrox1_reset", function () {
            ...
            return g ? !0 : (g = !0, r.useBodyOverflow && a.css("overflow", "hidden"), r.onPopupOpen && r.onPopupOpen(), x.addClass("loading"), void l.fadeTo(r.fadeSpeed, 1, function () {
                x.trigger("poptrox1_switch", [o, !0])
            }))
        }).on("poptrox1_switch", function (o, p, i) {
            var s;
            if (!i && g) return !0;
        ...
        }).on("poptrox1_close", function () {
            return g && !r.usePopupForceClose ? !0 : (g = !0, x.hide().trigger("poptrox1_reset"), r.onPopupClose && r.onPopupClose(), void l.fadeOut(r.fadeSpeed, function () {
                r.useBodyOverflow && a.css("overflow", "auto"), g = !1
            }))
        }).trigger("poptrox1_reset"), r.usePopupEasyClose ? (m.on("click", "a", function (e) {
            e.stopPropagation()
        }), x.css("cursor", "pointer").on("click", function (e) {
            e.stopPropagation(), e.preventDefault(), x.trigger("poptrox1_close")
            ...
            if (x.is(":visible")) switch (e.keyCode) {
                case 37:
                case 32:
                    if (r.usePopupNav) return x.trigger("poptrox1_previous"), !1;
                    break;
                case 39:
                    if (r.usePopupNav) return x.trigger("poptrox1_next"), !1;
                    break;
                case 27:
                    return x.trigger("poptrox1_close"), !1
            }
            ...
            if ("ignore" != n && i.attr("href")) {
                ...
                switch (p = t.src.match(/\/\/[a-z0-9\.]+\/(.*)/), t.type) {
                    case "iframe":
                        ...
                        break;
                    case "ajax":
                        t.object = e('<div class="poptrox1-ajax"></div>'), t.object.on("click", function (e) {
                            e.stopPropagation()
                ...
                "file:" == window.location.protocol && t.src.match(/^\/\//) && (t.src = "http:" + t.src), d.push(t), s.removeAttr("title"), i.removeAttr("href").css("cursor", "pointer").css("outline", 0).on("click", function (e) {
                    e.preventDefault(), e.stopPropagation(), x.trigger("poptrox1_open", [o])
                })
            }
        }), n.prop("_poptrox1", r), n
    }
}(jQuery);